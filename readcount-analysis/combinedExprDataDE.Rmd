...
for (i in 1:ncol(eb$p.value) ) {
  ...
  gsva.results <- gsva(data, topGenes_list.pathway.genes[[i]])
...
gsva.results <- gsva(data, msigdbr_list_h)
...
gsva.results <- gsva(data, msigdbr_list_c6)
...
gsva.results <- gsva(data, reactome_pathways.gene_symbols)
...
gsva.results <- gsva(data, pathways.selected)
...
#gsva.results <- gsva(data, pathways.selected, mx.diff=FALSE)
gsva.results <- gsva(data, pathways.genes)
