...
### KEGG pathways {.tabset}

Gene set enrichment analysis based on the *[KEGG](https://www.genome.jp/kegg/){target="_blank"}* repository.
...
```{r KEGG_gsea_analysis_heatmap, comment = NA, message=FALSE, warning=FALSE, fig.width = 12, fig.height = 3, results = 'hide'}
...
```{r KEGG_gsea_visualisation, echo=FALSE, comment = NA, message=FALSE, warning=FALSE, fig.width = 12, fig.height = 12, results="asis"}
setwd(KEGG_dir)
...
Over-representation analysis based on the *[KEGG](https://www.genome.jp/kegg/){target="_blank"}* repository.
...
## MSigDB and Reactome pathways {.tabset}
...
Heatmap presenting enrichment scores for [Reactome](https://reactome.org/PathwayBrowser){target="_blank"} pathways (*y-axis*) across all samples (*x-axis*).

```{r Reactome_pathways_heatmap, echo=FALSE, comment = NA, message=FALSE, warning=FALSE, fig.width = 12, fig.height = 12, results = 'hide'}
##### Create folder for storing pathway analysis results plots
...
Table presenting enrichment scores for [Reactome](https://reactome.org/PathwayBrowser){target="_blank"} pathways (*y-axis*) across all samples (*x-axis*).

```{r Reactome_pathways_table, echo=FALSE, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, results="asis"}
##### Trim pathways names length to 50 characters
rownames(gsva.results) <- substring(rownames(gsva.results), 1, 50)
