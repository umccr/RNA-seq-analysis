  ...
  if ( !is.na(topGenes_list[[i]]) ) {
    ...
    if ( length(genes.ENTREZID) > 1 ) {
      ...
      if ( !is.null(enrichKEGG.results) && nrow(enrichKEGG.results) > 0 ) {
        ...
        enrichKEGG.results.genes <- unlist(strsplit(enrichKEGG.results4table$geneID, split='/', fixed=TRUE))
        ...
        enrichKEGG.results4table$geneID <- paste(enrichKEGG.results.genes_symbols, collapse = " / ")
