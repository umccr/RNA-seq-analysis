    ...
    if ( length(genes.ENTREZID) > 1 ) {
      ...
      if ( !is.null(enrichKEGG.results) && nrow(enrichKEGG.results) > 0 ) {
        ...
        for ( j in 1:nrow(top_enrichKEGG.genes[[i]]) ) {
          ...
          write.table(data2plot_topGenes , file=paste(paste0(params$output_dir, "/", paste0(params$results_name)), "_", colnames(eb$p.value)[i], "_DE_genes_exprs_", make.names(top_enrichKEGG.genes[[i]]$Description[j]), ".txt", sep=""),sep="\t", quote=FALSE, row.names=TRUE, col.names=NA, append = FALSE)
        }
    ...
    if ( length(genes.ENTREZID) > 1 ) {
      ...
      if ( !is.null(gseKEGG.results) && nrow(gseKEGG.results) > 0 ) {
        ...
        for ( j in 1:nrow(top_gseKEGG.genes[[i]]) ) {
          ...
          write.table(data2plot_topGenes , file=paste(paste0(params$output_dir, "/", paste0(params$results_name)), "_", colnames(eb$p.value)[i], "_DE_genes_exprs_", make.names(top_gseKEGG.genes[[i]]$Description[j]), ".txt", sep=""),sep="\t", quote=FALSE, row.names=TRUE, col.names=NA, append = FALSE)
        }
    ...
    if ( length(genes.ENTREZID) > 1 ) {
      ...
      if ( !is.null(enrichDGN.results) && nrow(enrichDGN.results) > 0 ) {
        ...
        for ( j in 1:nrow(enrichDGN.genes[[i]]) ) {
          ...
          write.table(data2plot_topGenes , file=paste(paste0(params$output_dir, "/", paste0(params$results_name)), "_", colnames(eb$p.value)[i], "_DE_genes_exprs_", make.names(enrichDGN.genes[[i]]$Description[j]), ".txt", sep=""),sep="\t", quote=FALSE, row.names=TRUE, col.names=NA, append = FALSE)
        }
        ...
        ##### Create summary bar and dot plots
        png(file = paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichDGN.png", sep=""))
...
for( i in 1:ncol(eb$p.value) ){
  ...
  if ( length(topGenes_list[[i]]) > 1 ) {
    ...
    if ( !is.na(enrichDGN[[i]]) ) {
      ...
      cat(paste0("![](", paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichDGN.png)", sep="")), "\n")
      cat("\n***\n")
      ...
      ##### Create heatmap-like functional classification
      png(file = paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichDGN_heatmap.png", sep=""))
      print(heatplot(enrichDGN.genes[[i]], foldChange=data.pathways[[i]], showCategory = 30))
      invisible(dev.off())
        
      cat(paste0("![](", paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichDGN_heatmap.png)", sep="")), "\n")
      cat("\n***\n")
      ...
      for ( j in 1:nrow(enrichDGN.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/summary_", rownames(enrichDGN.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(KEGG_dir, "/summary_", rownames(enrichDGN.df[[i]])[j], ".network.png)", sep="")), "\n")
    ...
    if ( length(genes.ENTREZID) > 1 ) {
      ...
      if ( !is.null(gseNCG.results) && nrow(gseNCG.results) > 0 ) {
        ...
        for ( j in 1:nrow(top_gseNCG.genes[[i]]) ) {
          topGenes_list.pathway <- top_gseNCG.genes[[i]]$geneID[j]
          topGenes_list.pathway <- unique(unlist(strsplit(topGenes_list.pathway, split='/', fixed=TRUE)))
          data2plot_topGenes <- data2plot[ rownames(data2plot) %in% topGenes_list.pathway, ]
          
          write.table(data2plot_topGenes , file=paste(paste0(params$output_dir, "/", paste0(params$results_name)), "_", colnames(eb$p.value)[i], "_DE_genes_exprs_", make.names(top_gseNCG.genes[[i]]$Description[j]), ".txt", sep=""),sep="\t", quote=FALSE, row.names=TRUE, col.names=NA, append = FALSE)
        }
        ...
        ##### Create summary bar and dot plots
        png(file = paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_gseNCG.png", sep=""))
...
for( i in 1:ncol(eb$p.value) ){
  ...
  if ( length(topGenes_list[[i]]) > 1 ) {
    ...
    if ( !is.na(top_gseNCG[[i]]) ) {
      ...
      cat(paste0("![](", paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_gseNCG.png)", sep="")), "\n")
      cat("\n***\n")
      ...
      ##### Create heatmap-like functional classification
      png(file = paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_gseNCG_heatmap.png", sep=""))
      print(heatplot(top_gseNCG.genes[[i]], foldChange=data.pathways[[i]], showCategory = 30))
      invisible(dev.off())
        
      cat(paste0("![](", paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_gseNCG_heatmap.png)", sep="")), "\n")
      cat("\n***\n")
      ...
      if ( !is.null(emapplot.results) ) {
        png(file = paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichment_map.png", sep=""))
        print(emapplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
          
        cat(paste0("![](", paste(KEGG_dir, "/summary_", gsub("\\s", "_", contrastNames[i], perl=TRUE), "_enrichment_map.png)", sep="")), "\n")
      ...
      for ( j in 1:nrow(top_gseNCG.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/summary_", rownames(top_gseNCG.df[[i]])[j], ".gsea.png", sep=""))
        print(gseaplot2(top_gseNCG[[i]], geneSetID = j, title = top_gseNCG[[i]]$Description[1]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(KEGG_dir, "/summary_", rownames(top_gseNCG.df[[i]])[j], ".gsea.png)", sep="")), "\n")
      ...
      for ( j in 1:nrow(top_gseNCG.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/summary_", rownames(top_gseNCG.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(KEGG_dir, "/summary_", rownames(top_gseNCG.df[[i]])[j], ".network.png)", sep="")), "\n")
