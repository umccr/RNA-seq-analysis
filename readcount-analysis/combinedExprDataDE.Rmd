    ...
    if ( !is.na(top_enrichKEGG[[i]]) ) {
      ...
      for ( j in 1:nrow(top_enrichKEGG.df[[i]]) ) {
        ...
        if ( rownames(top_enrichKEGG.df[[i]])[j] %!in% c("hsa04723", "hsa04215", "hsa05206") ) {
          ...
          file.rename(paste(KEGG_dir, "/", rownames(top_enrichKEGG.df[[i]])[j], ".png", sep=""), paste0(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".png"))
          file.rename(paste(KEGG_dir, "/", rownames(top_enrichKEGG.df[[i]])[j], ".xml", sep=""), paste0(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".xml"))
          file.rename(paste(KEGG_dir, "/", rownames(top_enrichKEGG.df[[i]])[j], ".pathview.png", sep=""), paste0(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".pathview.png"))
          
          cat(paste0("![](", paste(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".pathview.png)", sep="")), "\n")
        } else {
      ...
      for ( j in 1:nrow(top_enrichKEGG.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
          
        cat(paste0("![](", paste(KEGG_dir, "/enrichKEGG_", colnames(eb$p.value)[i], "_", rownames(top_enrichKEGG.df[[i]])[j], ".network.png)", sep="")), "\n")
    ...
    if ( !is.na(top_gseKEGG[[i]]) ) {
      ...
      for ( j in 1:nrow(top_gseKEGG.df[[i]]) ) {
        ...
        if ( rownames(top_gseKEGG.df[[i]])[j] %!in% c("hsa04723", "hsa04215", "hsa05206") ) {
          ...
          ##### Rename pathview plots
          file.rename(paste(KEGG_dir, "/", rownames(top_gseKEGG.df[[i]])[j], ".png", sep=""), paste0(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".png"))
          file.rename(paste(KEGG_dir, "/", rownames(top_gseKEGG.df[[i]])[j], ".xml", sep=""), paste0(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".xml"))
          file.rename(paste(KEGG_dir, "/", rownames(top_gseKEGG.df[[i]])[j], ".pathview.png", sep=""), paste0(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".pathview.png"))
          
          cat(paste0("![](", paste(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".pathview.png)", sep="")), "\n")
      ...
      for ( j in 1:nrow(top_gseKEGG.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".gsea.png", sep=""))
        print(gseaplot2(top_gseKEGG[[i]], geneSetID = j, title = top_gseKEGG[[i]]$Description[1]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".gsea.png)", sep="")), "\n")
      ...
      for ( j in 1:nrow(top_gseKEGG.df[[i]]) ) {
        ...
        png(file = paste(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(KEGG_dir, "/gseKEGG_", colnames(eb$p.value)[i], "_", rownames(top_gseKEGG.df[[i]])[j], ".network.png)", sep="")), "\n")
  ...
  if ( length(topGenes_list[[i]]) > 1 ) {
    ...
    if ( !is.na(enrichDGN[[i]]) ) {
      ...
      for ( j in 1:nrow(enrichDGN.df[[i]]) ) {
        ...
        png(file = paste(DisGeNET_dir, "/enrichDGN_", colnames(eb$p.value)[i], "_", rownames(enrichDGN.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(DisGeNET_dir, "/enrichDGN_", colnames(eb$p.value)[i], "_", rownames(enrichDGN.df[[i]])[j], ".network.png)", sep="")), "\n")
  ...
  if ( length(topGenes_list[[i]]) > 1 ) {
    ...
    if ( !is.na(top_gseNCG[[i]]) ) {
      ...
      for ( j in 1:nrow(top_gseNCG.df[[i]]) ) {
        ...
        png(file = paste(DisGeNET_dir, "/gseNCG_", colnames(eb$p.value)[i], "_", rownames(top_gseNCG.df[[i]])[j], ".gsea.png", sep=""))
        print(gseaplot2(top_gseNCG[[i]], geneSetID = j, title = top_gseNCG[[i]]$Description[1]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(DisGeNET_dir, "/gseNCG_", colnames(eb$p.value)[i], "_", rownames(top_gseNCG.df[[i]])[j], ".gsea.png)", sep="")), "\n")
      ...
      for ( j in 1:nrow(top_gseNCG.df[[i]]) ) {
        ...
        png(file = paste(DisGeNET_dir, "/gseNCG_", colnames(eb$p.value)[i], "_", rownames(top_gseNCG.df[[i]])[j], ".network.png", sep=""))
        print(cnetplot(topPathways.genes, foldChange=data.pathways[[i]]))
        invisible(dev.off())
        
        cat(paste0("![](", paste(DisGeNET_dir, "/gseNCG_", colnames(eb$p.value)[i], "_", rownames(top_gseNCG.df[[i]])[j], ".network.png)", sep="")), "\n")
