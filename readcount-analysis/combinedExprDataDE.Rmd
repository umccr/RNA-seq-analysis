...
for (i in 1:ncol(eb$p.value) ) {
  ...
  topGenes <- topGenes[,colnames(topGenes) %in% c("logFC","t","lods","P.Value","adj.P.Val")]
...
for (i in 1:ncol(eb$p.value) ) {
  ...
  if ( length(topGenes_list[[i]] ) != 0 ) {
    ...
    topGenes_list[[i]]  <- topGenes_list[[i]] [,colnames(topGenes_list[[i]] ) %in% c("ENTREZID", "logFC","t","lods","P.Value","adj.P.Val")]
