...
### DisGeNET pathways {.tabset}

Gene set enrichment analysis based on the *[DisGeNET](https://www.disgenet.org/){target="_blank"}* repository.
...
Over-representation analysis based on the *[DisGeNET](https://www.disgenet.org/){target="_blank"}* repository.
