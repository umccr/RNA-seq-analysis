...
if ( params$filter && params$transform == "CPM" ) {
  ...
  y$filtered.transformed.batch.removed <- limma::removeBatchEffect(y$filtered.transformed, batch = ref_datasets.list[[dataset]][["sample_annot"]]$Dataset)
...
##### TPM transformation without filtering
  ...
  if ( params$log ) {
    ...
    y$transformed <- log2(tpm_from_rpkm(y$transformed+0.25))
    y$transformed.batch.removed <- limma::removeBatchEffect(y$transformed, batch = ref_datasets.list[[dataset]][["sample_annot"]]$Dataset)
