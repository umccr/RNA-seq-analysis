...
densityPlot(genes=genes, data=y$transformed, main_title="Transformed data", x_title=params$transform, distributions = "normal") 
  
##### Normalised data
if ( tolower(params$norm) != "none" ) {
  
  #### Interactive genes distribution plot
  densityPlot(genes=genes, data=y$norm, main_title="Normalised data", x_title=params$transform, distributions = "normal") 
}
