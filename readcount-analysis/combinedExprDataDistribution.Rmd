...
write.table(prepare2write(datasets), file = paste0(params$output_dir, "/", params$results_name,".combined_counts.txt"), sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE, append = FALSE )
