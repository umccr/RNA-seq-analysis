...
if ( params$filter ) {
  ...
  densityPlot(genes=genes, data=y.sub$filtered.transformed, main_title="Transformed and filtered data", x_title=params$transform,
              sampleName=params$sample, distributions = c("normal", "binomial",  "bimodal") )
  
} else {
  
  densityPlot(genes=genes, data=y.sub$transformed, main_title="Transformed data", x_title=params$transform, sampleName=params$sample,
...
if ( tolower(params$norm) != "none" ) {
  ...
  #### Interactive genes distribution plot
  densityPlot(genes=genes, data=y.sub$norm, main_title="Normalised data", x_title=params$transform, sampleName=params$sample, 
              distributions = c("normal", "binomial", "bimodal") ) 
}

densityPlot(genes=genes, data=y.sub$z, main_title="Z-score data", x_title=params$transform, sampleName=params$sample,
            distributions = c("normal", "binomial",  "bimodal") ) 
