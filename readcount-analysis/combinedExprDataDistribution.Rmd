...
combineDatasets <- function(sample_name, ref_dataset) {
...
ref_datasets.list[[dataset]] <- combineDatasets(sample_name=params$sample_name, ref_dataset=ref_dataset[[dataset]][1])
