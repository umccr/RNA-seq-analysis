...
params:
  exprDir: '/Users/jmarzec/data/Pancreatic_data_harmonization/expression/Reference_datasets/UMCCR/Combined_data'
  exprFile: 'UMCCR_PC.counts.matrix.txt'
  ...
  ensembl: FALSE
  results_name: 'UMCCR_PC_cleaned_genes_distributions_TPM_quantile'
  ensembl_version: 86
output:
  html_document:
    keep_md: yes
