...
if ( !is.na(gene) ) {
  if ( params$filter ) {
    ...
    widges.list[[plotsNo]] <- densityPlot(genes=gene, data=y.sub$filtered.transformed, main_title="Transformed and filtered data", x_title=params$transform,
                sampleName=samples, distributions = c("normal", "binomial",  "bimodal") )
  } else {
    widges.list[[plotsNo]] <- densityPlot(genes=gene, data=y.sub$transformed, main_title="Transformed data", x_title=params$transform, sampleName=samples,
