...
if ( !is.na(gene) ) {
  ...
  if ( tolower(params$norm) != "none" ) {
    ...
    widges.list[[plotsNo]] <- densityPlot(genes=gene, data=y.sub$norm, main_title="", x_title=paste0("Normalised ", params$transform), sampleName=samples, distributions = c("normal", "binomial", "bimodal") ) 
  }
