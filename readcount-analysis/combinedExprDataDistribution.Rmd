...
densityPlot <- function(genes, data, main_title, x_title, sampleName = NULL, distributions = NULL, plot_mode = "static") {
  ...
  for (i in 1:nrow(data)) {
    ...
    data.df <- rbind(data.df, data.frame(gene = genes[i], expr = density(data[i,])$x, dens = density2freq(density(data[i,])$y)))
  }
...
densityPlot(genes=genes, data=y.sub$z, main_title="Z-score data", x_title=params$transform, distributions = "normal") 
