...
densityPlot <- function(genes, data, x_title, sampleName = NULL, distributions = NULL, plot_mode = "static") {
...
densityPlot(genes, y$transformed, params$transform) 
  
##### Normalised data
if ( tolower(params$norm) != "none" ) {
  
  #### Interactive genes distribution plot
  densityPlot(genes, y$norm, params$transform)
}
