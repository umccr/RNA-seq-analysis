...
if ( !is.na(gene) ) {
  ...
  if ( tolower(params$norm) != "none" ) {
    ...
    widges.list[[plotsNo]] <- comparPlot(genes=gene, dataset1=y.sub$norm, dataset2=transformed.data, main_title="", x_title=paste0("Normalised ", params$transform), y_title=params$transform, sampleName=samples )
      
    ##### Check the effect of data Z-score transformation 
    widges.list[[plotsNo+1]] <- comparPlot(genes=gene, dataset1=y.sub$norm, dataset2=y.sub$z, main_title="", x_title=paste0("Normalised ", params$transform), y_title="Z-score", sampleName=samples )
