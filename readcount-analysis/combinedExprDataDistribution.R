...
#
#	 Command line use example: Rscript  combinedExprDataDistribution.R --exprDir /Combined_data --exprFile CUP.counts.matrix.txt --annotFile CUP_Target.txt --transform CPM --norm TMM --filter TRUE --log TRUE --genes All --ensembl TRUE --results_name CUP
#
