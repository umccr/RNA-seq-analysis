...
par(mfrow=c(3,1), mar=c((max(nchar(colnames(y$noNorm)))+3)/2, 5, 3, 2))
...
if ( tolower(params$norm) != "none" ) {
  ...
  plot(y$noNorm, y$norm, col=targets.colour[[2]], main="", pch=".", las=2, title(main=paste0("Unmormalised vs normalised data (", params$norm, ")")), xlab=params$transform, ylab=paste0(params$transform, " (", params$norm, ")"))
...
par(mfrow=c(3,1), mar=c(max(nchar(colnames(y$noNorm)))/2, 5, 3, 2))
