...
for ( i in 1:ncol(data_NOISeq) ) {
  ...
  explo.plot(biodetection_samples, samples = colnames(data_NOISeq)[i], plottype = "persample")
  invisible(dev.off())
}
```
...
for ( i in 1:ncol(data_NOISeq) ) {
  ...
  explo.plot(countsbio_samples, samples = colnames(data_NOISeq)[i], plottype = "boxplot")
  invisible(dev.off())
}
```
...
for ( i in 1:ncol(data_NOISeq) ) {
  ...
  explo.plot(saturation, toplot = 1, samples = colnames(data_NOISeq)[i])
  invisible(dev.off())
}
```
