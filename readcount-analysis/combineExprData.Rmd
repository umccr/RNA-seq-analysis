...
write.table(geneMatrix2write(y.norm.cpm), file=paste0(params$projectDir, "/", paste(datasetIDs, collapse="_"),"_TMM.txt"),sep="\t", quote=FALSE, row.names=FALSE, append = FALSE)
```
