...
my_images <- list.files(path = "./images/rseqc/", pattern = "star.clipping_profile.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```

*kallisto bam*

```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "kallisto.clipping_profile.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "*.deletion_profile.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "star.insertion_profile.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "kallisto.insertion_profile.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "*.NVC_plot.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "star.splice.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
...
```{r, out.width = "400px", echo=FALSE}
my_images <- list.files(path = "./images/rseqc/", pattern = "kallisto.splice.*.jpg", full.names = TRUE)
knitr::include_graphics(my_images)
```
